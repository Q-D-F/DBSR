...
def generate_mod_LR_bic():
    ...
    up_scale = 4
    mod_scale = 4
    # set data dir  Sagittal
    sourcedir = "/home/zmdz/name/szy/CMI/medical/Sagittal"
    savedir = "/home/zmdz/DDSR-main/DDSR-main/DIV2K/Sagittal_HR_bic"
    ...
    filepaths = [f for f in os.listdir(sourcedir) if f.endswith(".BMP")]
